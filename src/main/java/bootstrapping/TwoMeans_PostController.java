...
public class TwoMeans_PostController extends Splat_Dialog {
    ...
    BootedStat_DialogView boot_ChooseStats_DialogView;
    ...
    TwoMeans_Controller twoMeans_Controller;
    
    public TwoMeans_PostController(NonGenericBootstrap_Info nonGen,
                                   TwoMeans_Controller twoMeans_Controller, 
                                   String varDescr, 
                                   double[] theBooteds) { 
        if (printTheStuff) {
            System.out.println("43 *** TwoMeans_PostController, constructing");
        }
        this.twoMeans_Controller = twoMeans_Controller;
        this.nonGen = nonGen;
    ...
    public String doThePostControllerThing() {   
        if (printTheStuff) {
            System.out.println("56 --- TwoMeans_PostController, doThePostControllerThing()");
        } 
        ...
        double thetaNull = twoMeans_Controller.getInd_T_HypothesizedDiff();
        ...
        public TwoMeans_PostController getTheBoot_Controller() { return this; }    
        ...
        public BootedStat_DialogView get_Boot_DialogView() {return boot_ChooseStats_DialogView; }    
