...
public abstract class Super_BootedStat_DialogView extends BivariateScale_W_CheckBoxes_View {
    ...
    Bootstrap_Dashboard chooseStats_Dashboard;
    Boot_DistrModel originalDistrModel,
                    shiftedDistrModel;
    NonGenericBootstrap_Info nonGen;
    SmartTextFieldsController stf_Controller;
 
    Super_BootedStat_DialogView( NonGenericBootstrap_Info nonGen,
                              Bootstrap_Dashboard chooseStats_Dashboard,
                     double placeHoriz, double placeVert,
                     double withThisWidth, double withThisHeight) {
        super(placeHoriz, placeVert, withThisWidth, withThisHeight); 
        if (printTheStuff) {
            System.out.println("\n75 *** Super_BootedStat_DialogView, Constructing");
        }
        this.nonGen = nonGen;
        originalDistrModel = nonGen.getOriginalDistrModel();
        shiftedDistrModel = nonGen.getShiftedDistrModel();
