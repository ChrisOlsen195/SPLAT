...
public class DotPlot_DistrView extends Super_ChooseStats_DistrView {
    ...
    public DotPlot_DistrView(DistrModel distrModel,
    ...
    public void continueConstruction() {    
        ...
        boot_Controller.set_Boot_OriginalDotPlot_DistrView(this);
