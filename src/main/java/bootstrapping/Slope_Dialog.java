...
public class Slope_Dialog extends Two_Variables_Dialog{ 
    // POJOs
    ...
    final Text currNullDiff = new Text("Current null: (\u03C1\u2081) = ");
    ...
    public Slope_Dialog(Data_Manager dm, String variableType) {
        super(dm, "Slope_Dialog", "None");
        this.dm = dm;
        dm.whereIsWaldo(69, waldoFile, "\n *** Constructing");
        lblTitle.setText("Bootstrap Slope");
 ...
 private void makeHypotheses() {
        ...
        changeNull.setOnAction((ActionEvent event) -> {
            ...
            while (!okToContinue) {
                ...
                txtDialog.setContentText("What slope would you like to test? ");                     
                ...
                if (result.isPresent() == true) {
                    ...
                    try {
                        ...
                        okToContinue = false;
                        System.out.println("203 Slope_Dialog -- gen #");
 ...
 private void makeAlphaAndCIPanel() {
     ...
     public void ciChanged(ObservableValue<? extends String> observable,
        ...
        dm.whereIsWaldo(273, waldoFile, "--- alphaChanged to " + String.valueOf(alpha));
    ...
    public void alphaChanged(ObservableValue<? extends String> observable,
                                                    String oldValue,
                                                    String newValue) {
        dm.whereIsWaldo(282, waldoFile, "--- alphaChanged");
        alphaIndex = list_AlphaViews.getSelectionModel().getSelectedIndex();
        alpha = alphaLevels[alphaIndex];
        dm.whereIsWaldo(285, waldoFile, "--- alphaChanged to " + String.valueOf(alpha));
