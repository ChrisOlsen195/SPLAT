...
public class MLR_Resids_View extends MLR_Scatterplot_View {
    // POJOs
    ...
    public MLR_Resids_View(MLR_Model mlr_Model, MLR_Dashboard mlr_Dashboard,
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {
        
        super(mlr_Model, mlr_Dashboard, placeHoriz, placeVert,
                        withThisWidth, withThisHeight);   
        waldoFile = "MLR_Resids_View";
        // waldoFile = "";
        dm.whereIsWaldo(37, waldoFile, "Constructing");
        X = mlr_Model.getEstimatedProbs(); 
        Y = mlr_Model.getDevianceResids();

        dotRadius = 3.0;
        dotDiameter = 6.0;
        
        txtTitle1 = new Text(50, 25, " Residual plot ");
        String strTxtTitle2 = "Deviance residuals vs. " + mlr_Model.getLogisticProcedure().getExplanVar();
