...
public class GammaDistribution 
{
    ...
    double getLeftTailArea(double xValue)
    {
        if (xValue < 0.) {
            toString();
            throw new IllegalArgumentException("bad x in getLeftTailArea(double xValue) in Gammadist");
        }
    ...
    double getRightTailArea(double xValue)
    {
        if (xValue < 0.) {
            toString();
            throw new IllegalArgumentException("bad x in getRightTailArea(double xValue) in Gammadist");
        }
    ...
    double getDensity(double xValue)
    {
        if (xValue <= 0.) {
            toString();
            throw new IllegalArgumentException("bad x in getDensity(double xValue) Gammadist");
        }
    ...
    public double invcdf(double p) {
        if (p < 0. || p >= 1.) {
            toString();
            throw new IllegalArgumentException("bad p in invcdf(double p) in Gammadist");
        }
    ...
    public double invgammp(final double p, final double a) {
      ...
      gln=gammln(a);
      if (a <= 0.) throw new IllegalArgumentException("a must be pos in invgammap in GammaDist");
