...
public class Logistic_Model {         
    ...
    public Logistic_Model(Logistic_Controller logReg_Controller){
    ...
    private void printStatistics() {
        ...
        */
        ...
        // -------------------------------------------------------------------
            ...
            String truncated_One = StringUtilities.getleftMostNChars(twoCategories[1] + "         ", 7);
            logisticEquation[2] = " P(" + truncated_One + "} =  ------------------------------------------------";   
            ...
            logisticReport.add(String.format("          %10s", lrTable0));
   ...
   public String[] getTwoCategories(){ return logReg_Controller.getTwoCategories(); }
}