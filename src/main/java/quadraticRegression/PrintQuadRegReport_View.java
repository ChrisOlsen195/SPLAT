...
public class PrintQuadRegReport_View extends PrintTextReport_View {
    // POJOs
    
    // My classes
   
    public PrintQuadRegReport_View(QuadReg_Model regrModel,  QuadReg_Dashboard regrDashboard,
