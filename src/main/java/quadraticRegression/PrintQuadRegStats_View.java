...
public class PrintQuadRegStats_View extends PrintTextReport_View {
    // POJOs
    
    // My classes
   
    public PrintQuadRegStats_View(QuadReg_Model quadRegModel,  QuadReg_Dashboard quadRegDashboard,
