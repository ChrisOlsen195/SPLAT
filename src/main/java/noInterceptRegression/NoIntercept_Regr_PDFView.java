...
public class NoIntercept_Regr_PDFView extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    int df;
    ...
    //String waldoFile = "NoIntercept_Regr_PDFView";
    String waldoFile = "";
    ...
    public NoIntercept_Regr_PDFView(NoIntercept_Regr_Model noInt_Regr_Model, NoIntercept_Regr_Dashboard noInt_Regr_Dashboard, 
        ...
        df = noInt_Regr_Model.getDF();
        tStat = noInt_Regr_Model.getTStat();
        absValTStat = Math.abs(tStat);
        pValue = noInt_Regr_Model.getPValue();
        ...
        switch (hypotheses) {
            ...
            default:
                String switchFailure = "Switch failure: NoIntercept_Regr_PDFView 94" + hypotheses;
        ...
        if (assumptionCheckIsDesired) {
            ...
            for (int ithAlpha = 0; ithAlpha < 4; ithAlpha++) {
                ...
                switch (hypotheses) {
                    ...
                    default:
                        String switchFailure = "Switch failure: NoIntercept_Regr_PDFView  337 " + hypotheses;
                        MyAlerts.showUnexpectedErrorAlert(switchFailure); 
                }                 
            }
        }  
