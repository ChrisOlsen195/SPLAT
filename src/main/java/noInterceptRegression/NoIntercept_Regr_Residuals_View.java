...
public class NoIntercept_Regr_Residuals_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    double slope, intercept, sqrRootOfTwoOverTwo;

    String waldoFile = "NoInt_Regr_Residuals_View";
    //String waldoFile = "";
    ...
    public NoIntercept_Regr_Residuals_View(NoIntercept_Regr_Model noInt_Regr_Model, NoIntercept_Regr_Dashboard noInt_Regr_Dashboard,
        ...
        String strTxtTitle2 = "Residuals vs. " + noInt_Regr_Model.getExplanatoryVariable();
