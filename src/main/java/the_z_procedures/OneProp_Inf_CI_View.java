...
public class OneProp_Inf_CI_View extends Region {
    ...
    double initial_xMin, initial_xMax, initial_xRange, xMin, xMax, xRange,
           ...
           deltaX, dispLowerBound, dispUpperBound,  position_Low_CI,
           position_High_CI, initHoriz, initVert, initWidth, initHeight, 
           pHat, position_pHat;
    ...
    //public OneProp_Inf_CI_View () { }
    
    public OneProp_Inf_CI_View(OneProp_Inf_Model oneProp_Inf_Model, OneProp_Inf_Dashboard oneProp_Inf_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight)  
    {
        ...
        confIntForP = oneProp_Inf_Model.getConfIntForP();
        initStuff();
    }
    
    private void initStuff() {
        categoryLabels = FXCollections.observableArrayList();
        categoryLabels.add(oneProp_Inf_Model.getGraphProp());        
    ...
    public void setUpUI() {
        txtTitle1 = new Text(50, 25, " CI for the proportion ");        
        txtTitle2 = new Text (60, 45, oneProp_Inf_Model.getGraphTitle());
    ...
    public void doTheGraph() {
        ...
        position_Low_CI = xAxis.getDisplayPosition(confIntForP.getFirstValue());
        position_High_CI = xAxis.getDisplayPosition(confIntForP.getSecondValue()); 
        position_pHat = xAxis.getDisplayPosition(pHat);
        ...
        gcHBox.strokeLine(position_Low_CI, daYPosition_1, position_High_CI, daYPosition_1);
        gcHBox.strokeLine(position_Low_CI, upper_1, position_Low_CI, lower_1);
        gcHBox.strokeLine(position_High_CI, upper_1, position_High_CI, lower_1);    
        gcHBox.strokeOval(position_pHat - 5, daYPosition_1 - 5., 10., 10.);
