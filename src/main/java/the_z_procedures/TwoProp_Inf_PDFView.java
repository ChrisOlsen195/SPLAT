...
public class TwoProp_Inf_PDFView extends BivariateScale_W_CheckBoxes_View {
    ...
    public TwoProp_Inf_PDFView(TwoProp_Inf_Model twoProp_Inf_Model, TwoProp_Inf_Dashboard twoProp_Inf_Dashboard,
        ...
        txtTitle1 = new Text(50, 25, " Inference for independent proportions ");
        hypotheses = twoProp_Inf_Model.getHypotheses();
        alpha = this.twoProp_Inf_Model.getAlpha();
        
        zStatistic = this.twoProp_Inf_Model.getZStat();
        absVal_zStatistic = Math.abs(zStatistic);
        pValue = this.twoProp_Inf_Model.getPValue();
    ...
    protected void setUpUI() { 
        String title2String;
        txtTitle1 = new Text(50, 25, " Test for equality of two proportions");
        title2String = "  ";
