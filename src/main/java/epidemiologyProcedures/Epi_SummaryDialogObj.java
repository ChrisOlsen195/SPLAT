...
public class Epi_SummaryDialogObj {
    // POJOs
    int nRows, nCols;
    int[][] observedValues;
    ...
    public Epi_SummaryDialogObj(SmartTextField xVar,
                                    SmartTextField yVar,
    ...
    public Epi_SummaryDialogObj(Epi_Model fromBivCat)  {
        //System.out.println("\n57 Epi_SummaryDialogObj, Constructing from BivCat_Model");        
        strXValues = new String[nRows];
        strYValues =  new String[nCols];
        observedValues = new int[nRows][nCols];     
    }
      
    public Epi_SummaryDialogObj(ArrayList<String> fromEpiDialog)  {
        //System.out.println("\n64 Epi_SummaryDialogObj, Constructing from Epi Dialog");        
        nRows = 2; nCols = 2;
        strXValues = new String[nRows];
        strYValues =  new String[nCols];
    ...
    public Epi_SummaryDialogObj getTheDialogObject() { return this; }
    
    @Override
public String toString() {        
    String daReturnString = "finit Epi_SummaryDialogObj";
    ...
    System.out.println("END EpiSummaryDialogObj\n");
