...
public class MyAlerts {
   ...
   public MyAlerts() { 
    ...
    public static void showWeirdMatchedTRequest() { 
        showingAnAlert = true;
        alertTitle = "Weird Matched t Request Alert...";
        alertHeader = "OK, we need to have a bit of a chat here...";
        alertContext = "I am not quite sure what the deal is, dear User, but apparently you are requesting "
                        + " a Matched t inference procedure where the differences are all the same. I, SPLAT -- "
                        + " the Bucephalus of statistics programs -- am not going to horse around with this. "
                        + " Neigh, I say!! You have a P-value of 1.0, so fail to reject, and you don't need me to "
                        + " generate silly graphs.  If you do need silly graphs, find a different paddock. \n\n";
   ...
   public void setShowingAnAlert(boolean tf) { showingAnAlert = tf; }
    ...
    public static void showOutOfMemoryAlert() { 
        showingAnAlert = true;
        alertTitle = "Uh-oh, you've done it this time...";
        alertHeader = "Your computer has run out of heap memory!";
        alertContext = "I, SPLAT, ever vigilant and never trusting humans, have discovered a "
                        + " bit of a problem! Actually it is a big problem.  One might, if one"
                        + " were sufficiently poetic, say it is a heap big problem! (Tee-hee) "
                        + " Here's the deal.  While I, SPLAT, have infinite capability and much"
                        + " modesty, your computer has only finite memory. That part of memory "
                        + " I use for calculations and storing stuff has spilled over, and I'm "
                        + " going to bail. I COULD possibly stick my SPLAT nose into your memory"
                        + " and get more, but that is not guaranteed to work, and in any case I "
                        + " don't think it would be proper.  One possible solution to this problem "
                        + " might be to break your data file into separate files and run separate, "
                        + " smaller analyses. But for now, this is me waving good-bye... \n\n"; 
    ...
    public static void showBlankLabelsAlert() { 
        ...
        alertContext = "I, SPLAT, ever vigilant and never trusting humans, have discovered a "
                        ...
                        + " appear that you have transgressed.  This may be no big deal, it "
                        + " may be catastrophic, or somewhere between. You MAY be able to "
                        ...
                        + " are (a) not blank, and (2) correct. I, SPLAT the Vigilant, have "
    ...
    public static void showQuantANOVAPlotsAlert() { 
        ...
        alertContext = "For reasons apparently related to memory and hardware, the circle plot and"
                        + " homogeneity check plots are unstable. To get them to do what you want"
                        + " may be something of an adventure!  Somtimes circles will take a while to"
                        + " appear and disappear, and sometimes they will not appear until you click "
                        + " on the dashboard. You can change the scales (usually), but you should NEVER"
                        + " EVER attempt to resize these two plots -- I, SPLAT,will expire on the vine "  
                        + " if you do. It's not my fault, and as nearly as I can tell, it isn't my quasi-"
                        + " competent programmer's fault.  We all will just have to grin (or not) and bear"
                        + " it.  You can't fight city hall -- hardware and Mother Nature bats last.\n\n"; 
    ...
    public static void showMustBeNonBlankAlert() { 
        ...
        alertContext = "So what's the deal here?  With all due respect to John Locke, I, SPLAT, rise "
                        + " to object to this omission!!  Did you think this perfidy would pass without"
                        + " notice?!?  Are you one of those who trust in haruspices to somehow provide "
                        + " correct analysis with (a) the sparse information you provide and  (2) a"
                        + " consultation with the entrails of chickens?    That may have worked in "
                        + " ancient Rome, but it won't work here.  Let's try this entry thing again.\n\n"; 
    ...
    public static void showMustBeTwoUniquesInLogisticAlert() { 
        ...
        alertContext = "OK, User, here's the deal.  There is such a thing as polytomous logistic"
                        ...
                        + " and try again, this time with two values and thus gain the virtue and " 
                        + " confidence typically attached to Mark Twain's proverbial Presbyterian"
                        + " with four aces.\n\n";
    ...
    public static void showSillyProbabilityAlert() { 
        ...
        alertContext = "OK, you've had your fun now.  A or not A?  A and A?  A given A? SPLAT is"
                        + " less than appreciative of your (alleged) humor.  You may have time to"
                        + " play probability selection games, but I have better things to do: I "
                        + " am reading 'A Programmer's Guide to the Galaxy, and I think  I can "
                        + " safely say that not only is 42 not the answer here, neither is your"
                        + " selection.  User, get with the program and come up with better "
                        + " choices! \n\n"; 
    ...
    public static void showFourProbsShowingAlert() { 
        ...
        alertContext = "Incredibly, this problem is not of your creation, dear User. Of course, "
                        + " it is not SPLAT's fault either! The problem basically is that with"
                        + "  the calculation of four probabilities, it is not clear what direction"
                        + " to go. So SPLAT will pass the buck and let you, User, start selecting"
                        + " from scartch.\n\n";
    ...
    public static void showNoVariabilityAlert() { 
        showingAnAlert = true;
        alertTitle = "Ack!!  Alas, misguided User! We are confronted with unwanted homogeneity... ";
        ...
        alertContext = "OK, User, we need to talk.  All the data points in this column are the same.  Now,"
                        ...
                        + " calculations would be like walking into a  lions' den wearing a sirloin necktie.\n\n";
    ...
    public static void showNoReplicationInANOVA2Alert() { 
        showingAnAlert = true;
        alertTitle = "Ack!!  Alas, misguided User! You are bereft of variability... ";
        alertHeader = "I, SPLAT, cannot BELIEVE that you would ask me to analyze these data!";
        alertContext = "OK, User, we need to talk.  It is technically possible to have cells with only one"
                        + " value in them.  However, in SPLAT's view, variability in data is regarded as"
                        + " very virtuous. I, SPLAT, need to calculate things like Z-scores, correlations,"
                        + " stuff like that.  Without variability, such calculations would be like walking"
                        + " into a  lions' den wearing a sirloin necktie: dangerous to one's health.So to"
                        + " do this analysis you will need to find less virtuous statistical software.\n\n";
    ...
    public static void showTooManyRowsAlert() { 
        ...
        alertContext = "As you are aware, I, SPLAT, have no limitations whatsovever.  However,"
                        + " I consort with a two-bit programmer in a 64-bit world, and he is "
    ...
    public static void showGenericBadNumberAlert(String message) { 
        showingAnAlert = true;
        alertTitle = "Yo!  User!  That's not a " + message + "!";
        alertHeader = "You have entered something other than " + message +".";
        alertContext = "Thought you'd slip one by, did you?  Trying to impress your"
                     + " lab partner with your knowledge of more advanced math?"
                     + " Did you enter an ordered pair?  Something complex?  A matrix?"
    ...
    public static void showNoVarianceInANOVAAlert(String varLabel) { 
        ...
        alertContext = "User, you have a serious problem with the data in " +
                        ...
                        " might require, well, variance!?!?  Hello?!? You don't get variance "  +
                        ...
                        " in this deceitful attempt to analyze something not there, i.e. " +
    ...
    public static void showPropOopsAlert() { 
        ...
        alertContext = "Only (a) decimals between 0 and 1 and (b) counts greater than 0 and less than"
                        ...
                        + " with numbers within the bounds of mathematical respectability.\n\n"; 
    ...
    public static void showNotAllFieldsGoodAlert() { 
        ...
        alertContext = "Ok, listen up.  Some numbers gotta be positive, some gotta be integers,"
                        + " some gotta be probabilities, some gotta be nonzero, and Frank Sinatra"
                        + " has gotta be him.  I, SPLAT, do not make up the mathy rules, I only"
                        + " enforce them. SOMEwhere you have broken one or more of these rules."
                        + " Let's try this numeric entry thing again; this time put down"
                        + " that (allegedly) smart phone and pay attention.\n\n";  
    ...
    public static void showMissingDataAlert() { 
        showingAnAlert = true;
        alertTitle = "Uh-oh, we (i.e. you) have a problem with this file!";
        alertHeader = "Something seems to be missing here: data";
        alertContext = "I, SPLAT, ever vigilant and never trusting humans, have discovered a "
                        + " bit of a problem with this file! You, dear User, are required to"
                        + " have the same number of data values in each line, and that number "
                        + " must equal the number of labels in the first line of data. It doth"
    ...
    public static void showMissingNTreatmentsAlert() { 
        showingAnAlert = true;
        alertTitle = "What Ho! A Chicken Soup Alert!!!";
    ...
    public static void showZeroReplicationsAlert() { 
        ...
        alertHeader = "Why did I do all the prep work for you???";
    ...
    public static void showOnlyOneStatisticAllowedAlert() { 
        ...
        alertContext = "OK, User, we need to have a little chat.  I do a lot of work behind the scenes"
                        ...
                        + " handle more than one statistic at a time.  I am only thinking of you when"
                        + " I restrict you choices to one statistic to bootstrap at a time. Let's try"
                        + " this choice thing again from the top. Or not, as you wish.  Harumph!!!\n\n";
    ...
    public static void showMoreThanOneSelectionAlert() { 
        ...
        alertHeader = "Selecting a probability is like voting in Chicago!";
    ...
    public static void showBadRangeAlert() { 
        ...
        alertContext = "Ok, so here's the deal.  With apologies to those of the left hand "
                        ...
                        + " make the mathy rules, I only enforce them. Let's try this"
                        + " 'left is smaller than right' data entry thing again.\n\n";  
    ...
    public static void showNonSumToOneAlert() { 
        ...
        alertHeader = "There is a slight mathematical difficulty with your numbers.";
        alertContext = "The sum of your expected proportions is different from 1.0.  This could be"
                        ...
                        + " may be omniscient, but I don't read human minds.\n\n";
        
        backToTheRealWorld();
    }
    
    // Called by NoInt_Regr_Controller
    ...
    public static void showBadRMFileStructureAlert() { 
        ...
        alertContext = "So, what's the deal here?!?!?! Missing data, perhaps?  One of your subjects snuck out for some"
                        ...
                        + " analysis gods, are we?  You have been busted by the vaunted SBI (SPLAT Bureau of"
    ...
    public static void showEmptyCategoriesAlert() { 
        ...
        alertHeader = "A category is lost, stolen, kidnapped, or strayed...or perhaps forgotten?!?";
    ...
    public static void showNonPositiveRowAlert() { 
        ...
        alertContext = "Hey!  User!  I, SPLAT, know it is difficult to maintain a positive outlook on things" 
                        ...
                        + " and try this row entry thing again. \n\n"; 
    ...
    public static void showIncorrectDataTypeErrorAlert() { 
        showingAnAlert = true;
    ...
    public static void showBlankRowAlert() { 
        ...
        alertHeader = "Row, row, row whichever boat you wish, but if you are selecting a row here...";
        alertContext = "Hey!  User!  I, SPLAT, know it is difficult to maintain a positive outlook on things" 
    ...
    public static void showUnbalancedRBAlert() { 
        ...
        alertContext = "I, SPLAT, am chagrined to inform you of a mismatch between your design and your data." 
                        ...
                        + " approach.  I, SPLAT, in my infinite wisdom, perform this regression approach but " 
                        + " I will most definitely NOT set up the necessary 'dummy' variables that would be"
                        + " required.\n\n";
    ...
    public static void showDuplicateLabelAttemptedAlert() { 
        ...
        alertContext = "I, SPLAT, am chagrined to report that the label you want to use matches an existing"  
                        ...
                        + " method for choosing which variable you intend to use in a statistical procedure." 
    ...
    public static void nonCSVFileAlert() { 
        ...
        alertContext = "Not to put too fine a point on it, I am NOT a one trick pony." 
                + " I, SPLAT, am a one trick STALLION!  Just think of me as the " 
                + " statistics program moral equivalent of Bucephalus but sadly," 
                + " without a programmer of the quality of Alexander the Great." 
                + " But I digress.  The key thing here is that I do not read just " 
                + " any old files; I have very high standards. I read only Comma" 
                + " Separated Value (CSV) files.  If you can't handle that, find" 
                + " a less elegant and sophisticated statistics program to do" 
                + "  your data analysis. "
                + " \n\n                                                                              Yours truly, "
                + " \n                                                                                SPLAT the Great\n\n"; 
    ...
    public static void showUnexpectedErrorAlert(String message) { 
        ...
        alertContext = "Uh-oh, looks like my programmer has messed up YET AGAIN! " +
                          ...
                          "\n\n  You should save your current data to a NEW file, restart SPLAT, " +
                          " open the NEW file, and check to make sure your current data is OK. " +
                          "\n\n                          -- Your statistics buddy, SPLAT\n\n";
    ...
    public static void showFileReadErrorAlert() { 
        ...
        alertContext = " Well, it looks like my programmer has messed up AGAIN! " +
                       ...
                       " a long history of messing up with files and may be able to help." +
    ...
    public static void showTwoPointsAlert() { 
        ...
        alertHeader = "I, SPLAT, cannot BELIEVE that you, User, would ask me to do this regression.";
        alertContext = "OK, User, we need to chat.  One point is random chance, two points is a trend, and three points destiny."
    ...
    public static void showANCOVA_missingChoicesAlert() { 
        ...
        alertContext = "When running an Analysis of Covariance, it is customary for the User to choose " 
                       + " (a) a treatment variable, (2) a covariate, and (iii) a response variable."
                       + " That is a much better procedure than leaving the choice to me, SPLAT."
                       + " I am aware that counting is not easy for humans, so I have a suggestion."
                       + " Instead of counting, try to set up an injective holomorphic function"
                       + " between your choices and three values in the complex plane. If you are not"
                       + " sufficiently successful, go back and choose again.\n\n";
    ...
    public static void showANCOVA_LT2_LevelsAlert() { 
        ...
        alertContext = "If we are adhering to the strict definition of an experiment, it is perfectly OK" 
                       + " to have only one treatment. However, I, SPLAT, am into analyzing COMPARATIVE "
                       + " experiments. You CAN compare apples and oranges, but you need both to make"
                       + " that happen. So let's try to cut our ANCOVA teeth on more than one fruit."
                       + " When you have at least two treatments, give SPLAT a call.\n\n";
    ...
    public static void showANCOVA_NumericTreatmentAlert() { 
        ...
        alertContext = "In ANCOVA, the values of the treatment must be non-numeric.  I, SPLAT, have " 
                       + " detected only numeric entries in this (alleged!) treatment variable. It"
                       + " is probably the case that you have made an error in your selection of"
                       + " the treatment variable. I, SPLAT, regard this as a User error, and"
                       + " YOUR problem to fix. After fixing the problem give me, SPLAT, a call.\n\n";
    ...
    public static void showExplore2Ind_NE2_LevelsAlert() { 
        showingAnAlert = true;
        alertTitle = "Ack!  You have triggered The Terrible Non-Twos!";
        alertHeader = "OK, User, here is how it works when you are comparing two variables";
        alertContext = "Dear user, your ability to count levels is not unlike less than what" 
                       + " would generally be regarded as competent. If you wish to compare"
                       + " two groups, you should have two groups. Not fewer than two, not"
                       + " more than two; TWO!! Let's try this variable selection process again."
                       + " \n\n";
    ...
    public static void showMultReg_LT3_VariablesAlert() { 
        showingAnAlert = true;
        ...
        alertContext = "I, SPLAT, do not intend to criticize....much. But do you really believe that I," 
                       ...
                       + " problem?!?  Neigh, I say!!  I have standards!  And my reputation to consider! "
    ...
    public static void showMultUni_LT2_VariablesAlert() { 
        showingAnAlert = true;
        alertTitle = "Yo! User! You with the dearth of variables!";
        alertHeader = "OK, User, here is the deal: I canceled a hot date with a cool programmer";
        alertContext = "I, SPLAT, do not intend to criticize....much. But I, SPLAT, the Bucephalus" 
                       + " of statistical software, cleared enough memory and valuable movie time "
                       + " so that my incredible computing powers could be unleashed on your ALLEGEDLY"
                       + " multi-value problem. I have standards!  And my reputation to consider! "
                       + " And I only see one value for your variable.  If you really are looking "
                       + " at two or more values, let's get with the program. Grab that rodent device"
                       + " and march right back to the menu and recheck your options.\n\n";
    ...
    public static void showAttempAtSqrRtOfNegAlert(String varLabel) { 
        ...
        alertContext = "SPLAT hates to be a bearer of bad news, but there is a slight problem with"
                        ...
                        + varLabel + ", " + "has violated the implicit contract between the IOSR"
                        + " and you, the alleged quasi-competent statistician. The IOSR Lawyers from"
                        + " the firm of Dewey, Cheatham, and Howe, will soon be in touch.\n\n";
    ...
    public static void showTooFewChiSquareDFAlert() { 
        showingAnAlert = true;
        alertTitle = "Ha!  Caught you skimping on Chi Square rows or columns!";
    ...
    public static void showSampleSizeTooSmallAlert() { 
        showingAnAlert = true;
        alertTitle = "Ha!  Caught you skimping on sample size!  What were you thinking!?!?";
        alertHeader = "Just so you know, degrees of freedom are not taxed and are mostly free...";
        alertContext = "I, SPLAT, do not mean to suggest that you, dear User, have fewer clues than the number"
                        + " of degrees of freedom that your information implies, but...well, the shoes do seem to"
    ...
    public static void showTooFewUnbalancedANOVA2DFAlert() { 
        showingAnAlert = true;
        alertTitle = "Ha!  Caught you skimping on Error dfs!  What were you thinking!?!?";
        alertHeader = "Just so you know, degrees of freedom are not taxed and are mostly free...";
        alertContext = "I, SPLAT, do not mean to suggest that you, dear User, have fewer clues than the number"
                        + " of degrees of freedom that your information implies, but...well, the shoes do seem to"
    ...
    public static void showbadBinRangeAlert() { 
        showingAnAlert = true;
        alertTitle = "Bad ith bin range detected!!";
    ...
    public static void showLabelsDataMismatchAlert() { 
        showingAnAlert = true;
        alertTitle = "Yikes!  Problem reading the file...";
        alertHeader = "Mismatch of labels and data";
        alertContext = "It appears that at least one data line has more values than the number of labels."
                        + "\nI, SPLAT, though being virtually omniscient, cannot fix this problem.  Please"
                        + "\ncheck this file in your favorite word processor and try, try, again. \n\n";
        ...
        public static void showLabelLineMismatchAlert(int offendingLine) { 
        showingAnAlert = true;
        alertTitle = "Uh-0h, Ya Got Trouble in River City!!";
        alertHeader = "Something is shorter than something else";
        alertContext = "Yo!  User! What we have here, is Failure to Communicate!  This is NOT cool." + 
                                " As I, SPLAT The Only Almost Omniscient, read this situation -- er, file" +
                                "  -- there seems to be a mismatch between the number of variables you " + 
                                " claim are here, and the number of variables in one or more of your cases." +
                                " Were I SPLAT the Omniscient, I could fix this.  But I'm not and I can't." + 
                                " \n\nI CAN suggest that the offending line is somewhere near line " + String.valueOf(offendingLine) + "." +
                                " \n\nSo, I'm bailing out!  You will have to be the fixer.\n\n";
