...
public class UnivCat_FreqDistr {
    // POJOs
    boolean dragging;
    ...
    //String waldoFile = "UnivCat_FreqDistr";
    String waldoFile = "";  
    ...
    public UnivCat_FreqDistr(UnivCat_Model univCat_Model, UnivCat_Dashboard univCat_Dashboard,
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {
        dm = univCat_Model.getDataManager();
        dm.whereIsWaldo(68, waldoFile, "Constructing");
    ...
    private void setUpUI() {            
        txtTitle1 = new Text("Frequency Distribution");
