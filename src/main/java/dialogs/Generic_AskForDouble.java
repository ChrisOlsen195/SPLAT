...
public class Generic_AskForDouble  extends Splat_Dialog{
    // POJOs
    boolean checked;
    ...
    //String waldoFile = "Generic_AskForDouble";
    String waldoFile = "";
    ...
    public Generic_AskForDouble(Boot_Controller boot_Controller,   //  Calling class
        ...
        tfNReps.setOnAction(e -> {
            dm.whereIsWaldo(72, waldoFile, " ... Generic_AskForDouble, Constructing"); 
        ...
        btnOK.setOnAction(e -> {  
            System.out.println(" ... 85 Generic_AskForDouble, btnOK Clicked");
            nBoxesChecked = 0;
            boot_Controller.setReturnStatus("OK");
            boot_Controller.setExitStatus("OK");
            strReturnStatus = "OK";
        if (numberOfReps == 0 ) {
            dm.whereIsWaldo(90, waldoFile, " ... Generic_AskForDouble");
        ...
        btnCancel.setOnAction(e -> {  
            System.out.println(" ... 102 Generic_AskForDouble, btnCancel Clicked");
            boot_Controller.setReturnStatus("Cancel");
            boot_Controller.setExitStatus("Cancel");
            strReturnStatus = "Cancel";
            hide();
        ...
        setOnCloseRequest((WindowEvent we) -> {
            System.out.println(" ... 111 Generic_AskForDouble, setOnCloseRequest((WindowEvent we)");
            btnCancel.fire();
        });
