...
import static theRProbDists.MathFunctions.isNonInt;
...
public class Binomial extends GenericDistribution {
	...
	public static final double density_raw(double x, double n, double p, double q, boolean log_p)
	{
		...
		lc = MathFunctions.stirlerr(n) - MathFunctions.stirlerr(x) 
                        - MathFunctions.stirlerr(n-x) - MathFunctions.bd0(x,n*p) 
                            - MathFunctions.bd0(n-x,n*q);
