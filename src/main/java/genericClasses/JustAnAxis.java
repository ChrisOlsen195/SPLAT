...
public class JustAnAxis extends ValueAxis<Number> {
    ...
    public double getLB() { return lowerBound; }
    public double getUB() { return upperBound; }
    
    public String toString() {
        System.out.println("436 JustAnAxis, low/up bound = " + lowerBound + " / " + upperBound);
        return " JustAnAxis -- end toString";
    }
}
