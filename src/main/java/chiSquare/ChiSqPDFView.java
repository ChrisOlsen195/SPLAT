...
public class ChiSqPDFView extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    int maxSpaces, df;
    ...
    public ChiSqPDFView(X2GOF_Model x2GOF_Model, X2GOF_Dashboard x2GOF_Dashboard, 
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {

        super(placeHoriz, placeVert, withThisWidth, withThisHeight);
        //System.out.println("57 ChiSqPDFView, constructing");
    ...
    public ChiSqPDFView(X2Assoc_Model x2Assoc_Model, X2Assoc_Dashboard x2Assoc_Dashboard, 
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {
        super(placeHoriz, placeVert, withThisWidth, withThisHeight); 
