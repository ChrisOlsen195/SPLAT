...
public class X2Grid extends Control {     
    ...
    public X2Grid (int numberOfRows, int numberOfColumns){
        //System.out.println(" 38 X2Grid, constructing");
    ...
    public TextField getTF_col_row(int col, int row) { return tf[col][row]; }
    ...
    // Skin
    public class X2GriddyWiddySkin extends SkinBase<X2Grid> {    // Mastering JavaFX8 Controls, Chap 10
        public X2GriddyWiddySkin(X2Grid control) {               // I have no clue what this does!
            super(control);
        }
    }  
    ...
    public void handleEnter(int currentColumn, int currentRow, String gridDataElement) {         
        ...
        if ((currentRow > 0) && (currentColumn > 0)) {  //  Numeric field?
            ...
            isAnInteger = DataUtilities.strIsANonNegInt(temp);
            if (!isAnInteger) {
                MyAlerts.showGenericBadNumberAlert(" a non-negative integer ");
