...
public class X2_Grid extends Control {     
    // POJOs
    boolean isAnInteger;
    ...
    // Skin
    public class X2GriddyWiddySkin extends SkinBase<X2_Grid> {    // Mastering JavaFX8 Controls, Chap 10
        public X2GriddyWiddySkin(X2_Grid control) {               // I have no clue what this does!
            super(control);
        }
    }  
