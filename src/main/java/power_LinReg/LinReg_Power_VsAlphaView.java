...
public class LinReg_Power_VsAlphaView extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public LinReg_Power_VsAlphaView(LinReg_Power_Model linReg_Power_Model,
    ...
    public void setUpUI() {
        ...
        txtTitle_2 = new Text (String.format("Sample size = %3d, Effect Size = %4.2f", sampleSize, effectSize));
