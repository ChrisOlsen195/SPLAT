...
public class BivCat_Views_Super extends Region {
    // POJOs
    boolean dragging;
    
    public int nRowsCat, nLittleSquares, nDataPoints, nSquaresRow1, 
            nSquaresRow2;
    ...
    public String[] preStrTopLabels, preStrLeftLabels, strTopLabels, 
                           strLeftLabels,  top_Levels, 
                           left_Levels;
    ...
    public Canvas canvas_BivCat;
    public CategoryAxis categoryAxis_X;
    public GraphicsContext gc;
    HBox hBox_BivCat_CategoryBoxes;
    HBox[] squaresNText;
    Line line;
