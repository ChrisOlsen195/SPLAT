...
public class NoInf_Regression_Dashboard extends Dashboard {
    // POJOs
    //String subTitle;
    ...
    NoInf_Regression_Model noInf_Regression_Model;   
    NoInf_Regression_BestFit_View noInf_Regr_BestFit_View;   
    NoInf_Regression_Residuals_View noInf_ResidualsView;
    ...
    public NoInf_Regression_Dashboard(NoInf_Regression_Controller noInf_Regression_Controller, NoInf_Regression_Model noInf_Regression_Model) {
        super(4);
        //System.out.println("35 NoInf_Regression_Dashboard, constructing");
    ...
    public void populateTheBackGround() {        
        ...
        initWidth[1] = 660;
        initHeight[1] = 400;
        noInf_Regr_BestFit_View = new NoInf_Regression_BestFit_View(noInf_Regression_Model, this, sixteenths_across[1], sixteenths_down[1], initWidth[1], initHeight[1]);
        ...
        initWidth[2] = 660;
        initHeight[2] = 400;
        noInf_ResidualsView = new NoInf_Regression_Residuals_View(noInf_Regression_Model, this, sixteenths_across[2], sixteenths_down[2], initWidth[2], initHeight[2]);
