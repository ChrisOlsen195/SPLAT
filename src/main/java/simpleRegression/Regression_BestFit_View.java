...
public class Regression_BestFit_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public Regression_BestFit_View(Inf_Regression_Model inf_Regression_Model, Regression_Dashboard regression_Dashboard,
