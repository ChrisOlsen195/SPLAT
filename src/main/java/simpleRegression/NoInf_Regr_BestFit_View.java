...
public class NoInf_Regr_BestFit_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public NoInf_Regr_BestFit_View(NoInf_Regr_Model noInf_Regression_Model, NoInf_Regr_Dashboard noInf_RegrDashboard,
    ...
    private void makeItHappen() {
        dm.whereIsWaldo(117, waldoFile, " --- makeItHappen()");
    ...
    public void completeTheDeal() {
        dm.whereIsWaldo(126, waldoFile, " --- completeTheDeal()");
    ...
    public void doTheGraph() { 
        //dm.whereIsWaldo(141, waldoFile, " --- doTheGraph()");
