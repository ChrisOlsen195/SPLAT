...
public class Regression_Dashboard extends Dashboard {
    ...
    public Regression_Dashboard(Inf_Regression_Controller inf_Regression_Controller, Inf_Regression_Model inf_Regression_Model) {
        super(8);
    ...
    public void populateTheBackGround() {
        initWidth[0] = 450;
        initHeight[0] = 300;
        regression_PDFView = new Regression_PDFView(inf_Regression_Model, this, sixteenths_across[0], sixteenths_down[0], initWidth[0], initHeight[0]);
        ...
        initWidth[3] = 650;
        initHeight[3] = 350;
        bestFitView = new Regression_BestFit_View(inf_Regression_Model, this, sixteenths_across[3], sixteenths_down[3], initWidth[3], initHeight[3]);
        ...
        initWidth[4] = 650;
        initHeight[4] = 350;
        residualsView = new Regression_Residuals_View(inf_Regression_Model, this, sixteenths_across[4], sixteenths_down[4], initWidth[4], initHeight[4]);
        ...
        initWidth[7] = 550;
        initHeight[7] = 350;
        jointCI_View = new Regression_JointCI_View(inf_Regression_Model, this, sixteenths_across[7], sixteenths_down[7], initWidth[7], initHeight[7]);
