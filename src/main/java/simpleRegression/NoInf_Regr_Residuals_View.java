...
public class NoInf_Regr_Residuals_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public NoInf_Regr_Residuals_View(NoInf_Regr_Model noInf_Regression_Model, NoInf_Regr_Dashboard noInf_RegDashboard,
    ...
    public void doTheGraph() {      
        ...
        * Regression (1977). Technometrics 19(1): 15-18. Hines, R. J., &  *
        * Hines, W. G. (1995).  Exploring Cook's Statistic Graphically.   *
        * The American Statistician. 49(4): 1995, 389-394.  Letters to    *
        * the Editor (Obenchain, Cook). (1977). Technometrics 19(1):      *
        * 348-351.                                                        *
        ******************************************************************/   
         ...
         * Sources of Collinearity.  Wiley Interscience: New York.  p68    *
         ******************************************************************/
