...
public class Regression_PDFView extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public Regression_PDFView(Inf_Regression_Model inf_Regression_Model, Regression_Dashboard regression_Dashboard, 
        ...
        df = inf_Regression_Model.getDF();
        tStat = inf_Regression_Model.getTStat();
        absValTStat = Math.abs(tStat);
        pValue = inf_Regression_Model.getPValue();
        ...
        switch (hypotheses) {
            ...
            default:
                String switchFailure = "Switch failure: Regression_PDFView 97 " + hypotheses;
        ...
        if (assumptionCheckIsDesired) {
            ...
            for (int ithAlpha = 0; ithAlpha < 4; ithAlpha++) {
                ...
                switch (hypotheses) {
                    ...
                    default:
                        String switchFailure = "Switch failure: Regression_PDFView 337 " + hypotheses;
                        MyAlerts.showUnexpectedErrorAlert(switchFailure);
                }                 
            }
        }  
