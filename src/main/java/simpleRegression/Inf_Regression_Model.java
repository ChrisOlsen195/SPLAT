...
public class Inf_Regression_Model extends Regression_Model
{     
    // POJOs
    ...
    // My classes
    public Inf_Regression_Controller regression_Controller;

    // POJOs / FX
    
    public Inf_Regression_Model(Inf_Regression_Controller inf_regression_Controller) {   
