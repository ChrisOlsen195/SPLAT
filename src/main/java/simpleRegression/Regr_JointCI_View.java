...
public class Regr_JointCI_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public Regr_JointCI_View(Inf_Regr_Model inf_Regression_Model, Regr_Dashboard regression_Dashboard,
