...
public class Regr_PDFView extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public Regr_PDFView(Inf_Regr_Model inf_Regression_Model, Regr_Dashboard regression_Dashboard, 
        ...
        switch (hypotheses) {
            ...
            default:
                String switchFailure = "Switch failure: Regression_PDFView 101 " + hypotheses;
