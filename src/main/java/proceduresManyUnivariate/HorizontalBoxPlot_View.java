...
public class HorizontalBoxPlot_View extends Region { 
    ...
    public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, Indep_t_Dashboard independent_t_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 139 HorizontalBoxPlot_View, constructing");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel;   
    ...
    public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, Single_t_Dashboard single_t_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 158 HorizontalBoxPlot_View, constructing from single t Dashboard");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel; 
    ...
    public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, Matched_t_Dashboard matched_t_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 175 HorizontalBoxPlot_View, constructing");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel; 
        ...
        public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, MultUni_Dashboard multUni_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 189 HorizontalBoxPlot_View, constructing from hBoxModel");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel;
    ...
    public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, Regr_Compare_Dashboard ancova_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 202 HorizontalBoxPlot_View, constructing");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel; 
    ...
    public HorizontalBoxPlot_View(HorizontalBoxPlot_Model hBoxModel, ANCOVA_Dashboard ancova_Dashboard,
                        ...
                        double withThisWidth, double withThisHeight) {
        if (printTheStuff) {
            System.out.println("*** 215 HorizontalBoxPlot_View, constructing");
        }
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        this.hBoxModel = hBoxModel; 
    ...
    private void makeItHappen() {  
        if (printTheStuff) {
            System.out.println("--- 261 HorizontalBoxPlot_View, makeItHappen()");
        }
    ...
    public void completeTheDeal() { 
        if (printTheStuff) {
            System.out.println("--- 272 HorizontalBoxPlot_View, completeTheDeal()");
        }
    ...
    public void initializeGraphParameters() { 
        if (printTheStuff) {
            System.out.println("--- 286 HorizontalBoxPlot_View, initializeGraphParameters()");
        }
    ...
    private void makeTheCheckBoxes() {
        if (printTheStuff) {
            System.out.println("--- 325 HorizontalBoxPlot_View, makeTheCheckBoxes()");
        }
        ...
        for (int ithCB = 0; ithCB < nCheckBoxes; ithCB++) {
            ...
            hBoxCheckBoxes[ithCB].setOnAction(e->{
                ...
                switch (daID) {    
                    ...
                    default:
                        String switchFailure = "Switch failure: HorizontalBoxPlot_View 383 " + daID;
    ...
    public void doTheGraph() {
        if (printTheStuff) {
            //System.out.println("--- 418 HorizontalBoxPlot_View, doTheGraph()");
        }
