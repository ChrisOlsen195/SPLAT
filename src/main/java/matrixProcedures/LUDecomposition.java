   ...
   public Matrix solve (Matrix B) {
      ...
      if (!this.isNonsingular()) {
         // throw new RuntimeException("Matrix is singular.");
            Alert singularMatrixFound = new Alert(Alert.AlertType.ERROR);   
            singularMatrixFound.setTitle("Uh-oh, possible fatal problem here...");
            singularMatrixFound.setHeaderText("Houston may not have a problem, but Splat may have one.");
            singularMatrixFound.setContentText("OK, User, we need to talk.  Some of the high powered mathy stuff"
                                         + "\nthat I, Splat, do, requires what is known as Matrix algebra."
                                         + "\nSomehow, the data you have entered has resulted in what is known as"
                                         + "\na singular matrix.  This should NEVER happen, and I should really"
                                         + "\nbe more helpful here, but I may even blow up on you! Please send"
                                         + "\nto Chris Olsen, COlsen@mchsi.com, an email including the data or"
                                         + "\na description of what you are attempting to do so that he can"
                                         + "\nrespond by programming in some more helpful (non fatal) error."
                                         + "\n.For now, cross your fingers and hope that I'm still working."
                                         + "\n when you click for me to continue.  Apologies if I blow up!");        
            singularMatrixFound.showAndWait(); 
            Matrix oops = new Matrix(1,1);
            oops.set(0, 0, 0.0);
            return oops;
      }
