...
public class Table_FullMonte {
    ...
    private boolean doTheProbs() {
        ...
        switch(probToCalc) {
            ...
            default:
                String switchFailure = "Switch failure: 366 Table_FullMonte " + probToCalc;
    ...
    private void doTheDeedChoices() { table_View.doTheDeed(); }
    ...
    private void createNewViews() {
        table_View = null; 
        table_View = new Table_View(this);       
    }
    
    private void removeThePaneAndPickersChoices() {
        paneAndPickers.getChildren().removeAll(table_View.getPane(), colorPickersAndGrid);     
    }
    
    private void addThePaneAndPickersChoices() {
        table_View.doTheDeed();
        paneAndPickers.getChildren().addAll(table_View.getPane(), colorPickersAndGrid);       
    }
