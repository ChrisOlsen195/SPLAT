...
public class Tree_FullMonte {
    ...
    private boolean doTheProbs() {
        ...
        switch(probToCalc) {
            ...
            default:
                String switchFailure = "Switch failure: 365 Tree_FullMonte " + probToCalc;
    ...
    private void changeTextColorTo (Color thisColor) {clr_Text = thisColor; }
    ...
    private void doSomeInitializations() {
        System.out.println("708 Tree_FullMonte, doSomeInitializations()");
        clr_Yes = Color.RED;  
    ...
    public void doTheDeedChoices() { tree_View.doTheDeed(); }
    ...
    private void createNewViews() {
        tree_View = null; 
        tree_View = new Tree_View(this);       
    }
    
    private void removeThePaneAndPickersChoices() {
        paneAndPickers.getChildren().removeAll(tree_View.getPane(), colorPickersAndGrid);     
    }
    
    private void addThePaneAndPickersChoices() {
        tree_View.doTheDeed();
        paneAndPickers.getChildren().addAll(tree_View.getPane(), colorPickersAndGrid);       
    }
