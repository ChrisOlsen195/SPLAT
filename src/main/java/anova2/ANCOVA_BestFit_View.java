...
public class ANCOVA_BestFit_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    int nCases, nLevels;
    ...
    String waldoFile = "";
    // String waldoFile = "ANCOVA_BestFit_View";
    ...
    public ANCOVA_BestFit_View(ANCOVA_Model ancova_Model, ANCOVA_Dashboard ancova_Dashboard,
        ...
        xAxisLabel = ancova_Model.getANCOVA_Controller().get_CovariateName();
        yAxisLabel = ancova_Model.getANCOVA_Controller().get_ResponseName();
        ...
        cqdv = ancova_Model.getANCOVA_Controller().get_CatQuant_DV();
        nCheckBoxes = 0;
    ...
    public void bfvInitializeGraphParameters() { 
        dm.whereIsWaldo(96, waldoFile, "bfvInitializeGraphParameters()");
    ...
    private void makeItHappen() {    
        dm.whereIsWaldo(116, waldoFile, "makeItHappen()");
    ...
    public void bfvCompleteTheDeal() { 
        dm.whereIsWaldo(125, waldoFile, "bfvCompleteTheDeal()");
    ...
    public void bfvConstructDataArray() {
        dm.whereIsWaldo(137, waldoFile, "bfvConstructDataArray()");
