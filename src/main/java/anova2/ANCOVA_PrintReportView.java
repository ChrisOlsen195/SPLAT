...
public class ANCOVA_PrintReportView {
    // POJOs
    ...
    ANCOVA_PrintReportView(ANCOVA_Model ancova_Model,  ANCOVA_Dashboard ancova_Dashboard,
        ...
        anova1StringsToPrint = ancova_Model.getANCOVA_Report();
    }
    ...
    private void setUpUI() {
        titleText = new Text(250, 20, "      Analysis of Covariance");
