...
public class ANOVA2_RCB_MainEffect_AView extends ANOVA2_Views_Super { 
    
    // POJOs
    double daMiddleXPosition;
    
    String waldoFile = "";
    //String waldoFile = "ANOVA2_RCB_MainEffect_AView";
    
    // My Classes
    ANOVA2_RCB_Model anova2_RCB_Model;

    //  FX Classes
    AnchorPane anchorPane_MainEffectA;

    ANOVA2_RCB_MainEffect_AView(ANOVA2_RCB_Model anova2_RCB_Model, 
    ...
    private void setUpAnchorPane() {
        ...
        anchorPane_MainEffectA = dragableAnchorPane.getTheAP();
    ...
    public void doThePlot() {
        ...
        for (int theBetweenBatch = 1; theBetweenBatch <= nFactorA_Levels; theBetweenBatch++) {
            ...
            tempUCDO = anova2_RCB_Model.getPrelimA().getIthUCDO(theAppropriateLevel);   
    ...
    private void initializeGraphParams() { 
        ...
        ****************************************************************/       
        ...
        strTitle1 = "Main effect: " + anova2_RCB_Model.getBlockLabel();
