...
public class ANCOVA_Residuals_View extends BivariateScale_W_CheckBoxes_View {
    // POJOs
    ...
    public ANCOVA_Residuals_View(ANCOVA_Model ancova_Model, ANCOVA_Dashboard ancova_Dashboard,
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {        
        super(placeHoriz, placeVert, withThisWidth, withThisHeight);  
        initHoriz = placeHoriz; initVert = placeVert;
        initWidth = withThisWidth; initHeight = withThisHeight; 
        ancova_Controller = ancova_Model.getANCOVA_Controller();
    ...
    public void residvInitializeGraphParameters() { 
        //System.out.println("103 BivariateScale_W_CheckBoxes_View, initializeGraphParameters()");
    ...
    public void residsConstructDataArray() {
        //System.out.println("123 *** ANCOVA_BestFit_View, residsConstructDataArray()");
