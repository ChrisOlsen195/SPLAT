...
public class ANOVA2_MainEffect_BView extends ANOVA2_Views_Super { 
    // POJOs
    double daMiddleXPosition;
    
    String waldoFile = "";
    //String waldoFile = "ANOVA2_MainEffect_BView"; 
    
    // My Classes
    ANOVA2_Factorial_Model anova2_Factorial_Model;
    
    // FX Classes
    AnchorPane mainEffectB_AnchorPane;

    ANOVA2_MainEffect_BView(ANOVA2_Factorial_Model anova2_Factorial_Model, 
        ...
        preStrTopLabels = anova2_Factorial_Model.getFactorBLevels();
        preStrLeftLabels = anova2_Factorial_Model.getFactorALevels();
    ...
    public void doThePlot() {
        ...
        for (int theBetweenBatch = 1; theBetweenBatch < nFactorB_Levels; theBetweenBatch++) {
            daMiddleXPosition = categoryAxis_X.getDisplayPosition(factorB_Levels.get(theBetweenBatch));
            int theAppropriateLevel = theBetweenBatch;
            tempUCDO = anova2_Factorial_Model.getPrelimB().getIthUCDO(theAppropriateLevel);   
    ...
    private void initializeGraphParams() { 
        ...
        ****************************************************************/
        ...
        strTitle1 = "Main effect: " + anova2_Factorial_Model.getFactorBLabel();
        txtTitle1 = new Text(strTitle1);      
        txtTitle1.getStyleClass().add("titleLabel");                
        text1Width = txtTitle1.getLayoutBounds().getWidth();
        anchorPane_TitleInfo.getChildren().add(txtTitle1);
        ...
        categoryAxis_X.setLabel(anova2_Factorial_Model.getFactorBLabel());
