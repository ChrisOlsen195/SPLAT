...
public class IndepProps_Power_VsEffectSizeView extends BivariateScale_W_CheckBoxes_View
{
    ...
    public IndepProps_Power_VsEffectSizeView(IndepProps_Power_Model indepProps_Power_Model,
        ...
        //effectSize = indepProps_Power_Model.getEffectSize();
        //standErrDiffProps = indepProps_Power_Model.getStandErrNullDiffProps();
        strRejectionCriterion = indepProps_Power_Model.getRejectionCriterion();
        ...
        switch (strRejectionCriterion) {
            ...
            default:
                String switchFailure = "Switch failure: IndepProps_Power_VsEffectSizeView 76 " + strRejectionCriterion;
    ...
    public void setUpUI() {
        ...
        title2Text = new Text (String.format("Sample sizes = %3d,  %3d,  alpha = %3.2f", n_1, n_2, alpha));
