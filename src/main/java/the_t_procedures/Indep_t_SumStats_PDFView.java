...
public class Indep_t_SumStats_PDFView extends BivariateScale_W_CheckBoxes_View {
    ...
    public Indep_t_SumStats_PDFView(Indep_t_SumStats_Model indep_t_SumStats_Model, Indep_t_SumStats_Dashboard indep_t_SumStats_Dashboard, 
        ...
        hypotheses = indep_t_SumStats_Model.getHypotheses();
        alpha = indep_t_SumStats_Model.getAlpha();
        
        df = indep_t_SumStats_Model.getDF();
        tStat = indep_t_SumStats_Model.getTStat();
        absValTStat = Math.abs(tStat);
        pValue = indep_t_SumStats_Model.getPValue();
        //System.out.println("69 Indep_t_SumStats_PDFiew, pValue = " + pValue);
        ...
        switch (hypotheses) {
            ...
            default:
                String switchFailure = "Switch failure: Independent_t_SumStats_PDFView 94 " + hypotheses;
        ...
        if (assumptionCheckIsDesired) {
            ...
            for (int ithAlpha = 0; ithAlpha < 4; ithAlpha++) {
                ...
                switch (hypotheses) {
                    ...
                    default:
                        String switchFailure = "Switch failure: Independent_t_SumStats_PDFView 333 " + hypotheses;
                        MyAlerts.showUnexpectedErrorAlert(switchFailure);
                }                 
            }
        }
