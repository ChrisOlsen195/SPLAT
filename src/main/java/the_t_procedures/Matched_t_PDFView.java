...
public class Matched_t_PDFView extends BivariateScale_W_CheckBoxes_View
{
    // POJOs
    ...
    //String waldoFile = "Matched_t_PDFView";
    String waldoFile = "";
    ...
    public Matched_t_PDFView(Matched_t_Model matched_t_Model, Matched_t_Dashboard matched_t_Dashboard, 
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {
        super(placeHoriz, placeVert, withThisWidth, withThisHeight); 
        dm = matched_t_Model.getDataManager();
        ...
        hypotheses = matched_t_Model.getHypotheses();
        alpha = matched_t_Model.getAlpha();
        
        df = matched_t_Model.getDF();
        tStat = matched_t_Model.getTStat();
        absValTStat = Math.abs(tStat);
        pValue = matched_t_Model.getPValue();
        ...
        switch (hypotheses) {
            ...
            default:
                String switchFailure = "Switch failure: Matched_t_PDFView 97 " + hypotheses;
    ...
    public void doTheGraph() {   
        ...
        if (assumptionCheckIsDesired) {
            ...
            for (int ithAlpha = 0; ithAlpha < 4; ithAlpha++) {
                ...
                switch (hypotheses) {
                    case "NotEqual":
                        theCriticalValue = tDistr.quantile(1.0 - thisAlpha/2.0);    //  Right tail area
                    ...
                    default:
                        String switchFailure = "Switch failure: Matched_t_PDFView 342 " + hypotheses;
                        MyAlerts.showUnexpectedErrorAlert(switchFailure);
                }                 
            }
        } 
